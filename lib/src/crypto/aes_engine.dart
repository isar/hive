...
List<Uint32List> generateWorkingKey(List<int> key, bool forEncryption) {
...
void encryptBlock(List<List<int>> workingKey, Uint8List inp, int inpOff,
...
void decryptBlock(List<List<int>> workingKey, Uint8List inp, int inpOff,
    Uint8List out, int outOff) {
