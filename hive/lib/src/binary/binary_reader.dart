...
abstract class BinaryReader {
  ...
  ///
  /// If [byteCount] is not provided, it is also read from the disk.
  String readString([
    int byteCount,
  ...
  ///
  /// If [length] is not provided, it is also read from the disk.
  ...
  ///
  /// If [length] is not provided, it is also read.
  Map readMap([int length]);

  /// Read and decode any value.
  ///
  /// If [typeId] is not provided, it is also read.
